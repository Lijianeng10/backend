...
class ReportController extends Controller {
    ...
    public function actionGetReport() {
        ...
        $query = $query->groupBy(["l.store_no", "days"])
            ->orderBy("days desc,l.store_no asc");
        $result = $query->all();
    ...
    public function actionGetMonthReport() {
        ...
        $query = $query->groupBy(["l.store_no", "months"])
                ->orderBy("months desc");
        $result = $query->all();
        return $this->jsonResult(100, "获取成功", $result);
    }
