...
echo DetailView::widget([
    ...
    "attributes" => [
        [
            ...
            'format' => 'raw',
            'value' => function() {
                return Html::input("text", "periods", "", ["class" => "form-control need"]);
            }
                ], [
                    'label' => '赛事编码<span class="requiredIcon">*</span>',
                    'format' => 'raw',
                    'value' => function() {
                        return Html::input("text", "schedule_code", "", ["class" => "form-control need"]);
                    }
                        ], [
                            'label' => '赛事唯一mid<span class="requiredIcon">*</span>',
                            'format' => 'raw',
                            'value' => function() {
                                return Html::input("text", "schedule_mid", "", ["class" => "form-control need"]);
                            }
                                ], [
                                    'label' => '比赛开始时间<span class="requiredIcon">*</span>',
                                    'format' => 'raw',
                                    'value' => function() {
                                        $html = Html::input('text', "start_time", "", ["class" => "form-control start_time need", "placeholder" => "开始日期时间", "style" => "width:200px;display:inline;margin-left:5px;"]);
                                        return $html;
                                    }
                                        ], [
                                            ...
                                            'format' => 'raw',
                                            'value' => function() {
                                                $html = Html::input('text', "beginsale_time", "", ["class" => "form-control beginsale_time need", "placeholder" => "开始日期时间", "style" => "width:200px;display:inline;margin-left:5px;"]);
                                                return $html;
                                            }
                                                ], [
                                                    ...
                                                    'format' => 'raw',
                                                    'value' => function() {
                                                        $html = Html::input('text', "endsale_time", "", ["class" => "form-control endsale_time need", "placeholder" => "开始日期时间", "style" => "width:200px;display:inline;margin-left:5px;"]);
                                                        return $html;
                                                    }
                                                        ], [
                                                            ...
                                                            'value' => function($model) {
                                                                return Html::dropDownList("league", "0", $model["leagues"], ["class" => "form-control need", "id" => "league"]);
                                                            }
                                                                ], [
                                                                    'label' => '主队<span class="requiredIcon">*</span>',
                                                                    'format' => 'raw',
                                                                    'value' => function() {
                                                                        return Html::dropDownList("team_1", "", ["请选择"], ["class" => "form-control need", "id" => "team_1", "disabled" => "disabled"]);
                                                                    }
                                                                        ], [
                                                                            'label' => '客队<span class="requiredIcon">*</span>',
                                                                            'format' => 'raw',
                                                                            'value' => function() {
                                                                                return Html::dropDownList("team_2", "", ["请选择"], ["class" => "form-control need", "id" => "team_2", "disabled" => "disabled"]);
                                                                            }
                                                                                ], [
                                                                                    'label' => '让球数<span class="requiredIcon">*</span>',
                                                                                    'format' => 'raw',
                                                                                    'value' => function() {
                                                                                        return Html::input("text", "rq_nums", "", ["class" => "form-control need", "id" => "rq_nums"]);
                                                                                    }
                                                                                        ], [
                                                                                            'label' => '胜平负<span class="requiredIcon">*</span>',
                                                                                            'format' => 'raw',
                                                                                            'value' => function($model) {
                                                                                                return Html::dropDownList("schedule_spf", "", $model["items"], ["class" => "form-control need", "id" => "team_2"]);
                                                                                            }
                                                                                                ], [
                                                                                                    'label' => '让球胜平负<span class="requiredIcon">*</span>',
                                                                                                    'format' => 'raw',
                                                                                                    'value' => function($model) {
                                                                                                        return Html::dropDownList("schedule_rqspf", "", $model["items"], ["class" => "form-control need", "id" => "team_2"]);
                                                                                                    }
                                                                                                        ], [
                                                                                                            'label' => '比分<span class="requiredIcon">*</span>',
                                                                                                            'format' => 'raw',
                                                                                                            'value' => function($model) {
                                                                                                                return Html::dropDownList("schedule_bf", "", $model["items"], ["class" => "form-control need", "id" => "team_2"]);
                                                                                                            }
                                                                                                                ], [
                                                                                                                    'label' => '总进球数<span class="requiredIcon">*</span>',
                                                                                                                    'format' => 'raw',
                                                                                                                    'value' => function($model) {
                                                                                                                        return Html::dropDownList("schedule_zjqs", "", $model["items"], ["class" => "form-control need", "id" => "team_2"]);
                                                                                                                    }
                                                                                                                        ], [
                                                                                                                            'label' => '半全场胜平负<span class="requiredIcon">*</span>',
                                                                                                                            'format' => 'raw',
                                                                                                                            'value' => function($model) {
                                                                                                                                return Html::dropDownList("schedule_bqcspf", "", $model["items"], ["class" => "form-control need", "id" => "team_2"]);
                                                                                                                            }
                                                                                                                                ], [
                                                                                                                                    'label' => '是否热门<span class="requiredIcon">*</span>',
                                                                                                                                    'format' => 'raw',
                                                                                                                                    'value' => function($model) {
                                                                                                                                        return Html::radioList('hot_status', '0', ['1' => '是', '0' => '否']);
                                                                                                                                    }
                                                                                                                                        ], [
                                                                                                                                            'label' => '是否高中奖<span class="requiredIcon">*</span>',
                                                                                                                                            'format' => 'raw',
                                                                                                                                            'value' => function($model) {
                                                                                                                                                return Html::radioList('high_win_status', '0', ['1' => '是', '0' => '否']);
                                                                                                                                            }
                                                                                                                                                ], [
                                                                                                                                                    'label' => '操作',
                                                                                                                                                    'format' => 'raw',
