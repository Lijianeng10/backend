...
echo Html::input('hidden', 'team_id', $model['team_id']);
    ...
    "attributes" => [
        [
            ...
            'value' => function($model) {
                return Html::input("text", "team_code", $model['team_code'], ["class" => "form-control inputLimit need"]);
            }
                ], [
                    'label' => '球队简称<span class="requiredIcon">*</span>',
                    'format' => 'raw',
                    'value' => function($model) {
                        return Html::input("text", "team_short_name", $model['team_short_name'], ["class" => "form-control inputLimit need"]);
                    }
                        ], [
                            'label' => '球队全称<span class="requiredIcon">*</span>',
                            'format' => 'raw',
                            'value' => function($model) {
                                return Html::input("text", "team_name", $model['team_long_name'], ["class" => "form-control inputLimit need"]);
                            }
                                ], [
                                    'label' => '所属国家<span class="requiredIcon">*</span>',
                                    'format' => 'raw',
                                    'value' => function($model) {
                                        return Html::dropDownList("country", $model['country_code'], $model['country'], ["class" => "form-control inputLimit need"]);
                                    }
                                        ], [
                                            'label' => '缩略图',
                                            'format' => 'raw',
                                            'value' => function($model) {
                                                ...
                                                $html.=Html::img($scr, ["id" => "team_img", "style" => "filter:;border:2px inset #EEE"]);
                                                $html .= "<div>";
                                                ...
                                                return $html;
                                                    ...
                                                    'format' => 'raw',
                                                    'value' => function($model) {
                                                        return Html::textarea("remark", $model['team_remarks'], ["class" => "form-control", "style" => "height:60px;"]);
                                                    }
                                                        ], [
                                                            'label' => '操作',
                                                            'format' => 'raw',
                                                            'value' => function() {
                                                                $html = Html::button("保存", ["class" => "am-btn am-btn-primary inputLimit", "onclick" => "editSubmit();"]);
