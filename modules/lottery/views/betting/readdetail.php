...
//                                echo '<br/>';
                                ...
                                if (empty($model["lottery_numbers"])) {
                                    ...
                                    } elseif (in_array($model["lottery_id"], ['2005', '2006', '2007', '2008','2011','2010','2012'])) {
                                        $resultBalls = explode(",", $model["lottery_numbers"]);
                                        foreach ($betVals as $key => $val) {
                                            //前一单式复式
                                            if (in_array($playCodes[$key], ['200531', '200541', '200631', '200641', '200731', '200741', '200831', '200841','201131','201141','201031','201041','201231','201241'])) {
                                                $areas = explode(",", $val);
                                                ...
                                                $ret .= '</p>';
                                                //前二前三直选单式复式
                                            } elseif (in_array($playCodes[$key], ['200532', '200533', '200542', '200543', '200632', '200633', '200642', '200643', '200732', '200733', '200742', '200743', '200832', '200833', '200842', '200843','201132','201133','201142','201143','201032','201033','201042','201043','201232','201233','201242','201243'])) {
                                                ...
                                                //前二组选单式复式
                                            } elseif (in_array($playCodes[$key], ['200534', '200544', '200634', '200644', '200734', '200744', '200834', '200844','201134','201144','201034','201044','201234','201244'])) {
                                                $areas = explode(",", $val);
                                                ...
                                                $ret .="</p>";
                                                //前三组选单式复式
                                            } elseif (in_array($playCodes[$key], ['200535', '200545', '200635', '200645', '200735', '200745', '200835', '200845','201135','201145','201035','201045','201235','201245'])) {
                                                $areas = explode(",", $val);
                                                ...
                                                $ret .="</p>";
                                                //前二组选胆拖
                                            } elseif (in_array($playCodes[$key], ['200554', '200654', '200754', '200854','201154','201054','201254'])) {
                                                $ret .= '<p style="margin:0;padding:0"><span class="circlePrompt">' . $playNames[$key] . '</span>';
                                                $areas = explode("#", $val);
                                                $danBall = $areas[0];
                                                ...
                                                $ret .="</p>";
                                                //前三组选胆拖
                                            } elseif (in_array($playCodes[$key], ['200555', '200655', '200755', '200855','201155','201055','201255'])) {
                                                $ret .= '<p style="margin:0;padding:0"><span class="circlePrompt">' . $playNames[$key] . '</span>';
                                                $areas = explode("#", $val);
                                                ...
                                                $ret .="</p>";
                                            }else if(in_array($playCodes[$key], ['201163', '201164', '201165','200763', '200764', '200765','201263', '201264', '201265'])){
                                                 //乐选单式
                                                $ret .= '<p style="margin:0;padding:0"><span class="circlePrompt">' . $playNames[$key] . '</span>';
                                                $areas = explode(";", $val);
                                                foreach ($areas as $v) {
                                                ...
                                                $ret .="</p>";
                                            }else if(in_array($playCodes[$key], ['201166','201167','201168','200766','200767','200768','201266','201267','201268'])){
                                                 //乐选复式
                                                $ret .= '<p style="margin:0;padding:0"><span class="circlePrompt">' . $playNames[$key] . '</span>';
                                                $areas = explode(";", $val);
                                                foreach ($areas as $v) {
