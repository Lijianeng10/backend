...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "POST",
            url: "/lottery/betting/lan-detail",
            ...
            success: function (json) {
                ...
                if (['3001', '3002', '3003', '3004', '3005'].indexOf(data["lottery_id"]) != '-1') {
                    ...
                    competHtml += '<tr><td style="vertical-align: middle;">派奖时间</td><td>' + (data.award_time?data.award_time:"") + '</td></tr>';
...
//                            competHtml += "<img class='orderImg' src='" + picAry[i] + "'>";
        ...
        $("#content").on("click", "#getDetailMore", function () {
            ...
            $.ajax({
                url: "/lottery/betting/get-more-detail",
                async: false,
                type: 'POST',
                data: data,
                dataType: "json",
