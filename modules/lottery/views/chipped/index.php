...
//            ], 
            [
                ...
                'format' => 'raw',
                'value' => function($model){
                    return '<div class="am-btn-group am-btn-group-xs"> <span class="handle pointer" onclick="readDeatail(\'/lottery/chipped/readdetail?programme_code=' . $model['programme_code'] . '\')">查看</span>
                                </div>';
                }
            ]
        ]
...
<script>
    function goReset() {
        location.href = '/lottery/chipped/index';
    }
    function search(){
        ...
        location.href = '/lottery/chipped/index?programme_code='+programme_code+'&user_info='+user_info+'&lottery_code='+lottery_code+'&status='+status+'&security='+security;
    }
