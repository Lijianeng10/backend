...
$this->title = 'EditPicture';
?>
<?php
echo '<form id="editpicture">';
echo Html::input('hidden', 'pic_id', $data['picture_id'], ['id' => 'picture_id']);
    ...
    'attributes' => [
        [
            ...
            'value' => function($model) {
                return Html::input('text', 'type_code', $model['picture_type_code'], ['class'=>'form-control need', 'id'=>'type']);
            }
        ], [
            'label' => '类型名称<span class="requiredIcon">*</span>',
            'format' => 'raw',
            'value' => function($model) {
                return Html::input('text', 'type_name',$model['picture_type_name'],['class'=>'form-control need', 'id'=>'type_name']);
            }
        ], [
...
//        }
    ...
    $(function () {
        ...
        $('#editSubmit').click(function () {
            ...
            var data =$("#editpicture").serializeArray();
