...
echo '<input type="hidden" name="pay_type_id" value="' .$data['pay_type_id'] . '">';
    ...
    'attributes' => [
        [
            ...
            'value' => function($model) {
                return Html::input('text', 'pay_type_name', $model['pay_type_name'], ['class' => 'form-control']);
            }
        ], [
            'label' => '方式Code<span class="requiredIcon">*</span>',
            'format' => 'raw',
            'value' => function($model) {
                return Html::input('text', 'pay_type_code', $model['pay_type_code'], ['class' => 'form-control']);
            }
        ], [
            'label' => '方式父级<span class="requiredIcon">*</span>',
            'format' => 'raw',
            'value' => function($model) {
                return Html::input('text', 'parent_name', $model['parent_name'], ['class' => 'form-control', 'disabled' => 'disabled']);
            }
        ], [
            'label' => '排序<span class="requiredIcon">*</span>',
            'format' => 'raw',
            'value' => function($model) {
                return Html::input('number', 'pay_type_sort', $model['pay_type_sort'], ['class' => 'form-control']);
            }
        ], [
            'label' => '副标题',
            'format' => 'raw',
...
<script type="text/javascript">
    $(function () {
        $('#addSubmit').click(function () {
            ...
            $.ajax({
                url: '/admin/paytype/edit-pay-type',
                async: false,
                type: 'POST',
