...
class CallbackDetailController extends Controller {
    ...
    public function actionIndex() {
        ...
        $callback_status = $request->get('callback_status', '');
        $callStatus = CallbackDetail::CALL_STA;
        $dataInfo = CallbackDetail::find();
        if($callback_status!=""){
            $dataInfo =$dataInfo->where(["callback_status"=>$callback_status]);
        }
        $data = new ActiveDataProvider([
         ...
         return $this->render('index', ['data' => $data,'get'=>$get,'callStatus'=>$callStatus]);
    }
