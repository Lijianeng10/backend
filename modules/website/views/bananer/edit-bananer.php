    ...
    <form class="edit_bananer">
        ...
        <div class="am-form-group">
            ...
            <div style="margin-top: 10px;">
                ...
                <label>
                    <select id="info_type" class="need form-control" name="info_type" style="width:100px">
                        <?php foreach ($infoType as $key => $val) {
                            if ($key == $data["info_type"]) {
            ...
            <div style="margin-top: 10px;">
                ...
                <label>
                    <select id="league_code" class="need form-control" name="league_code" style="width:100px">
                        <?php foreach ($leagueCode as $key => $val) {
                            if ($key == $data["league_code"]) {
                                echo "<option selected = 'selected' value='" . $key . "'>" . $val . "</option>";
                            } else {
                                echo "<option  value='" . $key . "'>" . $val . "</option>";
                            }
...
<script>
    ...
    $('#addSubmit').click(function () {
        ...
        $.ajax({
            url: '/website/bananer/edit-bananer',
            async: false,
            type: 'POST',
            processData: false,
            contentType: false,
