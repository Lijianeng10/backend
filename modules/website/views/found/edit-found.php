    ...
    <form class="edit_bananer">
        ...
        <div class="am-form-group">
            <div>
                ...
                <label>
                    <input name="articleTitle" id="articleTitle" type="text" class="form-control need"
            ...
            <div style="margin-top:5px">
                ...
                <img src="<?php echo $data["pic_url"]; ?>" id="showimg" style="width: 700px;height: 200px"
            ...
            <div style="margin-top:5px">
                ...
                <img src="<?php echo $data["pc_pic_url"]; ?>" id="showimg2" style="width: 700px;height: 200px"
                     class="am-img-thumbnail">
...
<script>
    ...
    $('#addSubmit').click(function () {
        ...
        $.ajax({
            url: '/website/found/edit-bananer',
            async: false,
            type: 'POST',
            processData: false,
            contentType: false,
