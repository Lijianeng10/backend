...
echo Html::input("hidden", "", $data["batch"], ["id" => "batch"]);
echo Html::label("优惠类型  ", "", ["style" => "margin-left:15px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
echo Html::dropDownList("yh_type", $data["type"], $yh_type, ["class" => "form-control", "id" => "yh_type", "style" => "width:120px;display:inline;margin-left:5px;"]);
echo Html::label("使用彩种  ", "", ["style" => "margin-left:185px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
echo Html::dropDownList("use_range", $data["use_range"], $use_range, ["class" => "form-control", "id" => "use_range", "style" => "width:145px;display:inline;margin-left:5px;"]);
echo '</li>';
echo '<li style="margin-top:10px">';
echo Html::label("优惠券名称  ", "", ["style" => "margin-left:0px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
echo Html::input("input", "", $data["coupons_name"], ["class" => "form-control", "id" => "coupons_name", "placeholder" => "优惠券名称", "style" => "width:200px;display:inline;margin-left:5px;"]);
echo Html::label("优惠金额  ", "", ["style" => "margin-left:105px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
echo Html::input("input", "", $data["reduce_money"], ["class" => "form-control", "id" => "reduce_money", "placeholder" => "优惠金额", "style" => "width:200px;display:inline;margin-left:5px;"]);
echo '</li>';
echo '<li style="margin-top:10px">';
echo Html::label("适用类型  ", "", ["style" => "margin-left:15px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
echo Html::dropDownList("application_type", $data["application_type"], $application_type, ["class" => "form-control", "id" => "application_type", "style" => "width:120px;display:inline;margin-left:5px;"]);
echo Html::label("是否为礼品  ", "", ["style" => "margin-left:170px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
echo Html::dropDownList("is_gift", $data["is_gift"], $is_gift, ["class" => "form-control", "id" => "is_gift", "style" => "width:120px;display:inline;margin-left:5px;"]);
echo '</li>';
echo '<li style="margin-top:10px">';
echo Html::label("使用代理  ", "", ["style" => "margin-left:15px"]) . Html::tag("span", " ", ["class" => "requiredIcon"]);
echo Html::dropDownList("use_agents", $data["use_agents"], $proplayform, ["class" => "form-control", "id" => "use_agents", "style" => "width:120px;display:inline;margin-left:5px;"]);
echo '</li>';
echo '<li style="margin-top:10px">';
echo Html::label("预发数量  ", "", ["style" => "margin-left:15px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
echo Html::input("input", "", $data["numbers"], ["class" => "form-control", "id" => "numbers", "placeholder" => "预发数量", "style" => "width:200px;display:inline;margin-left:5px;"]);
...
echo Html::input("input", "", $data["days_num"], ["class" => "form-control", "id" => "days_num", "placeholder" => "单日限用张数", "style" => "width:200px;display:inline;margin-left:5px;"]);
...
echo Html::radioList('stack_use', $data["stack_use"], ['1' => '是', '2' => '否'], ["style" => "display:inline;margin-left:7px;"]);
...
echo Html::radioList('is_less_money', $data['is_limit_less'], ['0' => '否', '1' => '是'], ["style" => "display:inline;margin-left:7px;"]);
...
echo Html::input("number", "less_money", $data["less_consumption"], ["class" => "form-control", "id" => "less_money", "placeholder" => "最低消费", "style" => "width:200px;display:inline;margin-left:5px;", "min" => "0"]);
...
echo Html::radioList('is_sure_date', $data['is_sure_date'], ['0' => '否', '1' => '是'], ["style" => "display:inline;margin-left:7px;"]);
...
echo Html::input("text", "startdate", explode(" ", $data["start_date"])[0], ["id" => "startdate", "class" => "form-control", "data-am-datepicker" => "", "placeholder" => "开始日期", "style" => "width:120px;display:inline;margin-left:5px;"]);
echo "-";
echo Html::input("text", "enddate", explode(" ", $data["end_date"])[0], ["id" => "enddate", "class" => "form-control", "data-am-datepicker" => "", "placeholder" => "结束日期", "style" => "width:120px;display:inline;margin-left:5px;"]);
echo '</li>';
...
echo Html::input("number", "sure_time", $data['sure_time'], ["class" => "form-control", "id" => "sure_time", "placeholder" => "有效天数", "style" => "width:200px;display:inline;margin-left:5px;", "min" => "1"]);
...
echo Html::tag("textarea", $data["send_content"], ["class" => "form-control", "id" => "content", "placeholder" => "尊敬的会员,您获得优惠券{优惠券},券号{券号}，有效期至{有效期}，使用条件:需最低消费{最低消费}元。详情咨询:{电话}", "style" => "width:570px;display:inline;margin-left:5px;height:110px"]);
echo '</li>';
echo '<li style="margin-top:10px">';
echo Html::button("提交", ["class" => "am-btn am-btn-primary inputLimit", "id" => "addBtn", "style" => "margin-left:250px;"]);
echo Html::button("返回", ["class" => "am-btn am-btn-primary inputLimit", "id" => "closeBtn"]);
echo '</li>';
?>
<script>
    //用户兑换类的数量和类型不可修改
    ...
    if (application_type == 2) {
        $("#application_type").attr("disabled", true);
    ...
    if($("input[name='is_less_money']:checked").val() == 1){
        $("#less_user").show();
    }
    if($("input[name='is_sure_date']:checked").val() == 1){
        $("#sure_date").hide();
        $("#sure_periods").show();
    }else {
        $("#sure_periods").hide();
    ...
    $("#addBtn").click(function () {
        ...
        if (type == 0 || use_range == "") {
            ...
            $.ajax({
                url: "/website/coupons/edit-coupons-detail",
                data: {batch: batch, type: type, use_range: use_range, coupons_name: coupons_name, numbers: numbers, reduce_money: reduce_money, days_num: days_num,
