...
<div style="font-size:14px;">
    <form action="/website/ac-banner/index">
...
<script>
    ...
    //新增
    function addBananer() {
        location.href ='/website/ac-banner/add-bananer'
    }
    //重置
    function goReset() {
        location.href = '/website/ac-banner/index';
    }
    //删除广告
    function delBananer(id) {
        msgConfirm('提醒',"您确定要删除该广告吗", function () {
            $.ajax({
                url: "/website/ac-banner/del-bananer",
                type: "POST",
                async: false,
                data: {bananer_id: id},
                dataType: "json",
    ...
    function editSta(id, status) {
        ...
        msgConfirm('提醒', str, function () {
            $.ajax({
                url: "/website/ac-banner/edit-status",
                type: "POST",
                async: false,
    ...
    function editBananer(id){
        location.href ='/website/ac-banner/edit-bananer?bananer_id='+id
