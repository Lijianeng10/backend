...
<div style="font-size:14px;">
    <form action="/website/finance-banner/index">
...
<script>
    ...
    //新增
    function addBananer() {
        location.href ='/website/finance-banner/add'
    }
    //重置
    function goReset() {
    ...
    function delBananer(id) {
        msgConfirm('提醒',"您确定要删除该广告吗", function () {
            $.ajax({
                url: "/website/finance-banner/del",
                type: "POST",
                async: false,
                data: {banner_id: id},
                dataType: "json",
    ...
    function editSta(id, status) {
        ...
        msgConfirm('提醒', str, function () {
            $.ajax({
                url: "/website/finance-banner/edit-sta",
                type: "POST",
                async: false,
    ...
    function editBananer(id){
        location.href ='/website/finance-banner/edit?bananer_id='+id
