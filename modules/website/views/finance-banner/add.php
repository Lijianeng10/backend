...
<div>
    ...
    <div>
        <div>
            <span class="infoSpan" style="display: inline-block;padding-left: 30px;">标题</span>
            <label>
                <input name="articleTitle" id="articleTitle" type="text" class="form-control" placeholder="文章标题"
                       style="width: 200px;">
            </label>
        </div>
...
//        formData.append("upfile2", $("#picture2").get(0).files[0]);
        ...
        $.ajax({
            url: '/website/finance-banner/add',
            async: false,
            type: 'POST',
            processData: false,
            contentType: false,
