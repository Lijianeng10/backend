    ...
    <form class="add_loan">
        <div>
            <div>
                ...
                <label>
                    <input name="title" id="title" type="text" class="form-control need" placeholder="贷款标题" style="width: 200px;">
                </label>
            </div>
            <div>
                <span class="infoSpan" style="display: inline-block;padding-left: 10px;">副标题</span>
                <label>
                    <input name="subTitle" id="subTitle" type="text" class="form-control" placeholder="副标题" style="width: 200px;">
                </label>
            </div>
            <div>
                <span class="infoSpan" style="display: inline-block;padding-left: 10px;">额度范围<span style="color: red">*</span></span>
                <label>
                    <input name="quota" id="quota" type="text" class="form-control need" placeholder="额度范围 类：0元~20元" style="width: 200px;">
                </label>
            </div>
            ...
            <div>
                ...
                <label>
                    <input name="profit" id="profit" type="number" class="form-control need" placeholder="贷款利率 保留两位小数" style="width: 200px;" min="0"  step="0.01">
                </label>
            </div>
            ...
            <div>
                ...
                <label>
                    <input name="profitRemarkTop" id="profitRemarkTop" type="text" class="form-control nend minZero" placeholder="利率说明 类：日利息 等" style="width: 150px;border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;display:inline-block">
                    <span id="p-profit"></span>
                    <input name="profitRemarkTail" id="profitRemarkTail" type="text" class="form-control" placeholder="类：起 等" style="width: 100px;border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;display:inline-block;">
                </label>
            </div>
            ...
            <div>
                ...
                <label>
                    <input name="loanPeriods" id="loan_periods" type="text" class="form-control nend" placeholder="贷款期限  类：6~12月" style="width: 200px;">
                </label>
            </div>
            ...
            <div>
                ...
                <label>
                    <input name="sort" id="sort" type="number" class="form-control minZero" placeholder="显示优先级 数值越小 显示越靠前" style="width: 200px;" min="0" value="100">
                </label>
            </div>
            ...
            <div style="margin-top:5px;" id="jump">
                <div>
                    ...
                    <label><input type="text" name="jumpUrl" id="jumpUrl" class="form-control need" placeholder="跳转地址" style="width:300px"/></label>
            ...
            <div style="margin-top:2px;">
                ...
                <label>
                    <div style="width: 140px;height: 140px; text-align: center;border: 1px solid #BECDD5;position: relative;float: left;padding: 2px" id="pic_up">
                        <img id="img_url" style="width: 100%; height: 100%" src="/image/u1529.png">
                ...
                <span style="color:red;font-size:14px;">图片宽高最佳为68*68;图片大小限制为200k以下</span>
            </div>
        </div>
