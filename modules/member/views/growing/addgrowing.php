    ...
    <form class="am-form add_levels" id="doc-vld-msg">
        <fieldset>
            <div class="am-form-group" >
                ...
                <label id="growth_source">
                    <select id="source" name="growth_source">
                        ...
                        <option class="growth_source" value="<?php echo $key;?>"><?php echo $val;?></option>
                        <?php endforeach;?>
                    </select>
                </label>
            </div>
            ...
            <div class="am-form-group">
                ...
                <label>
                    <input type="text" class="need" name="growth_value"  placeholder="成长值" data-validation-message="请填写正确的正整数0-∞" pattern="^\d+$" min="0" required/>
                </label>
            </div>
            <div class="am-form-group" id="growth_need">
                <label for="doc-vld-age-2-1" class="form-word">成长机制<span style="color: red">*</span></label>
                <label>
                    <textarea class="need" name="growth_remark" rows="2" style="width:350px;height:70px;" required></textarea>
                </label>
            </div>
            
            <button class="am-btn am-btn-secondary" id="addSubmit" style="margin-left:100px;">提交</button>
