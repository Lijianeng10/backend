...
<script type="text/javascript">
    $(function () {
        ...
        function getSaleDetail(options) {
            ...
            var data = $.extend({sNo:sNo,timer: timer, months: months, page: 1, lotteryId: lotteryId, totaldays: totaldays,star:star,end:end}, options);
            $.ajax({
                url: "/report/report/get-sale-detail",
                type: "POST",
                data: data,
                async: false,
                dataType: "json",
                success: function (json) {
                    ...
                    $.each(json["result"]["list"], function (key, val) {
                        ...
                        html += "<td style='text-align: center'>" + val.out_time + "</td>"
                        html += "<td style='text-align: center'>"+store+"</td>"
