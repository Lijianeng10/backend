...
<div>
    ...
    <form class="add_gift" id="giftType3"">
        ...
        echo Html::dropDownList("giftType", "", $giftType, ["class" => "need form-control", "id" => "giftType", "style" => "width:120px;display:inline;margin-left:12px;margin-bottom:10px;"]);
        ...
        <div class="am-form-group">
            ...
            <label><input type="text" name="gift_name" id="gift_name" class="need form-control" placeholder="礼品名称" style="width: 300px;" required/></label>
        </div>
        <div class="am-form-group">
            <label class="infoSpan">礼品副标题<span style="color: red"> </span>&nbsp;&nbsp;</label>
            <label><input type="text" name="subtitle" id="subtitle" class=" form-control" placeholder="礼品副标题" style="width: 300px;"/></label>
        </div>

        <div class="am-form-group">
            <label class="infoSpan">库存数量<span style="color: red">*</span>&nbsp;&nbsp;</label>
            <label><input type="text" name="in_stock" id="in_stock" class="need form-control" placeholder="库存" data-validation-message="请填写正确的正整数" pattern="^\d+$" required/></label>
        </div>
        ...
        <div class="am-form-group">
            ...
            <label id="cate_sel"><select id="gift_cate" class="need form-control" name="gift_cate" ><?php foreach ($cateList as $key => $val): ?><option value="<?php echo $key; ?>"><?php echo $val ?></option><?php endforeach; ?></select></label>
        </div>
        <?php
        echo '<li style="margin-bottom:10px">';
        echo Html::label("活动时间  ", "",["style"=>"margin-left:10px"]) . Html::tag("span", "*", ["class" => "requiredIcon"]);
        echo Html::input("text", "startdate", "", ["id" => "startdate", "class" => " need form-control", "data-am-datepicker" => "", "placeholder" => "开始日期", "style" => "width:120px;display:inline;margin-left:15px;"]);
        echo " - ";
        echo Html::input("text", "enddate", "", ["id" => "enddate", "class" => "need form-control", "data-am-datepicker" => "", "placeholder" => "结束日期", "style" => "width:120px;display:inline;margin-left:5px;"]);
        echo '</li>';
        ?>
        <div class="am-form-group">
            <label class="infoSpan">所需等级<span style="color: red">*</span>&nbsp;&nbsp;</label>
            <label id="cate_sel"><select id="gift_leave" class="need form-control" name="gift_leave" style="width:130px" ><?php foreach ($levelAry as $key => $val): ?><option  value="<?php echo $key; ?>"><?php echo $val ?></option><?php endforeach; ?></select></label>
        </div>

        <div class="am-form-group">
            <label class="infoSpan">所需咕币<span style="color: red"> </span>&nbsp;&nbsp;</label>
            <label><input type="text" name="gift_glcoin" class="form-control" placeholder="兑换所需咕币" data-validation-message="请填写正确的正整数" pattern="^\d+$" required/></label>
        </div>
        <div class="am-form-group">
            <label class="infoSpan">电信积分<span style="color: red"> </span>&nbsp;&nbsp;</label>
            <label><input type="text" name="gift_integral" class="form-control" placeholder="兑换所需电信积分" data-validation-message="请填写正确的正整数" pattern="^\d+$" required/></label>
        </div>
        ...
        <div class="am-form-group">
            ...
            <img src="/image/u1529.png" id="showimg2" style="width: 250px;height: 200px" class="am-img-thumbnail">
