 ...
 * @property integer $is_service_fee
 */
class Store extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['store_code', 'user_id', 'company_id', 'store_type', 'cert_status', 'real_name_status', 'status', 'opt_id', 'amap_id', 'invite_status', 'his_win_nums', 'made_nums', 'consignment_type', 'business_status', 'weight', 'is_service_fee'], 'integer'],
            [['cust_no'], 'required'],
