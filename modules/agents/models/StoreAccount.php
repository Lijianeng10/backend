...
class StoreAccount extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['store_id', 'store_code', 'account_name', 'account_nums', 'open_bank', 'bank_address', 'bank_branches', 'reserved_tel'], 'required'],
            [['store_id'], 'integer'],
            [['create_time', 'modify_time', 'update_time'], 'safe'],
            [['store_code', 'account_name', 'open_bank'], 'string', 'max' => 50],
