...
{ 
    ...
    { 
        return [
            ...
            [['store_id', 'opt_id'], 'integer'],
            [['create_time', 'modify_time', 'update_time'], 'safe'],
            [['cust_no', 'sports_consignee_code', 'welfare_consignee_code', 'company_name', 'business_license', 'operator_card', 'old_owner_name', 'now_owner_name', 'consignee_img2'], 'string', 'max' => 100],
            [['consignee_name'], 'string', 'max' => 20],
            [['consignee_card', 'old_owner_card', 'now_owner_card'], 'string', 'max' => 18],
            [['operator_name'], 'string', 'max' => 50],
            [['remark'], 'string', 'max' => 255],
            [['consignee_img', 'consignee_card_img1', 'consignee_card_img2', 'consignee_card_img3', 'consignee_card_img4', 'old_owner_card_img1', 'old_owner_card_img2', 'business_license_img', 'competing_img', 'football_img', 'sports_nums_img', 'sports_fre_img', 'north_single_img', 'welfare_nums_img', 'welfare_fre_img'], 'string', 'max' => 150],
        ]; 
    } 
