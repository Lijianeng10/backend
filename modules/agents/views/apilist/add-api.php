<div style="margin-top: 20px;margin-left: 10px;font-size: 14px;">
    <lable>接口名称：</lable>
    <input type="text" placeholder="接口名称"  id="api_name" style="width:60%"/>
</div>
<div style="margin-top: 10px;margin-left: 41px;font-size: 14px;">
    <lable>URL：</lable>
    <input type="text" placeholder="URL"  id="api_url" style="width:60%"/>
</div>
...
<script>
    $("#addBtn").click(function(){
        ...
        if(api_name==""){
            ...
            $.ajax({
                url: "/agents/apilist/add-api",
                data: {"api_name":api_name,"api_url":api_url},
                type: "POST",
                dataType: "json",
                async: false,
