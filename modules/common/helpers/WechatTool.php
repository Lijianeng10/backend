...
use app\modules\common\models\WechatModel;
...
//        }
     ...
     * @return
     */
    public function sendTemplateMsgBetStore($title, $userOpenId, $order_code, $userName, $orderMoney, $orderTitle, $orderLimitTime, $remark,$store_name='',$province='') {
        ...
        $wechatModel->addWxMsgRecord($data, $userOpenId, 1, $status, $order_code,$store_name,$province);
        return $ret;
    }
