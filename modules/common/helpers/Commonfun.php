...
//        return $arr;
     ...
     * @param type $remark
     */
    public static function sysAlert($title, $level, $errorInfo, $status, $remark, $type = 'YF') {
        ...
        switch ($type) {
            case 'YF': // 研发自己
                if (YII_ENV == "dev") {
                    ...
                    $wx[] = "oV4Ujw53u2li86du5hl4YcHED0KE";//家能
            ...
            case 'KF': // 客服
                if (YII_ENV == "dev") {
                    ...
                    $wx[] = "oV4Ujww7Yx6kEPCNw47LPSK2YZHo";
                    $wx[] = "oV4Ujwyl00Y9yTer8vS80ZqbSpk4";
                    $serverName = "正式服务";
                }
                break;
            case 'LD': // 客服
                if (YII_ENV == "dev") {
                    ...
                    $wx[] = "oV4Ujw-zI7jGIsyE2esDSSiUVZv8";
                    $wx[] = "oV4UjwyWUVw5JGr4yvLJ6C7iMKio";
//                    $wx[] = "oV4Ujw8Eb0RocX85-KWD7yqc-qRM";//林中
                    $wx[] = "oV4Ujww7Yx6kEPCNw47LPSK2YZHo";
                    $wx[] = "oV4Ujw0WLvTTedpkTaKX44jPws64";
                    $wx[] = "oV4Ujw-lo3TmLhoTHBK0vI0iA5Is";
                    $wx[] = "oV4Ujwyl00Y9yTer8vS80ZqbSpk4";
                    $serverName = "正式服务";
                }
                break;
