 ...
 * @property integer $home_team_rank
 * @property integer $visit_team_rank
 * @property string $home_team_img
 * @property string $visit_team_img
 * @property integer $rq_nums
...
class ArticlesPeriods extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['articles_id', 'league_id', 'home_team_rank', 'visit_team_rank', 'rq_nums', 'featured', 'status'], 'integer'],
