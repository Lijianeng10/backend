...
<div class="header">
  <div class="wrap">
    <div class="left"><img src="/image/expert_login/logo.png" alt=""/><span>咕啦体育-专家管理后台</span></div>
  </div>
</div>
<div class="banner">
  <div class="container clear-fix">
    ...
    <aside>
      <h2>专家管理账号</h2>
      <form class="form" action="/expert/expert/login" method="post">
        <fieldset>
          ...
          <div>
            <label><input placeholder="用户名/手机号" type="text" name="admin_name" value="<?php echo isset($_POST["admin_name"]) ? $_POST["admin_name"] : ""; ?>"></label>
          </div>
          <div>
...
<!--找回密码模块-->
<!-- <div v-show="showResetPsd" class="reset-psd">
  <div class="cover"></div>
  <div class="reset">
    <p class="title">找回密码</p>
    <ul>
      <li class="clear-fix"><p>验证手机号：</p><input type="text" placeholder="请输入手机号"/></li>
      <li class="clear-fix"><p>短信验证码：</p><input placeholder="请输入短信验证码" type="text"><button class="disable">发送验证码</button></li>
      <li class="clear-fix"><p>新密码：</p><input placeholder="请输入新密码" type="password"></li>
      <li class="clear-fix"><p>重复新密码：</p><input placeholder="请输入新密码" type="password"></li>
    </ul>
    <div class="btn">
...
<footer>技术支持： 咕啦电子商务有限责任公司 Copyright 2014 All rights reserved</footer>
</body>
</html>