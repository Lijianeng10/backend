...
<span class = "handle pointer" onclick = "readExpert(\'/expert/expert/read-detail?expert_id=' . $model["expert_id"] . '\')">查看</span>
...
' . ($model["expert_status"] == 2 ? ('<span class = "handle pointer" onclick="editType(' . $model["user_id"] . ')">| 修改专家身份</span>') : "") .'</div>';
                            }
                        ]
                    ]
                ]);
...
<script>
    function search() {
        ...
        location.href = "/expert/expert/list?" + data;
    }
    function goReset() {
        location.href = "/expert/expert/list";
    }
