...
echo '<form action="/subchannel/apiorder/index" method="get">';
echo "<ul class='third_team_ul'>";
echo '<li>';
echo Html::label("接单编号", "", ["style" => "margin-left:15px;"]);
echo Html::input("input", "api_order_code", isset($_GET["api_order_code"]) ? $_GET["api_order_code"] : "", ["class" => "form-control", "placeholder" => "接单编号", "style" => "width:200px;display:inline;margin-left:5px;"]);
echo '</li>';
echo '<li>';
echo Html::label("商户订单号  ", "", ["style" => "margin-left:0px;"]);
echo Html::input("input", "third_order_code", isset($_GET["third_order_code"]) ? $_GET["third_order_code"] : "", ["class" => "form-control", "placeholder" => "商户订单号", "style" => "width:200px;display:inline;margin-left:5px;"]);
echo '</li>';
echo '<li>';
echo Html::label("彩种  ", "", ["style" => "margin-left:0px;"]);
...
echo '</li>';
//echo '<li>';
//echo Html::label("投注会员", "", ["style" => "margin-left:0px;"]);
//echo Html::input("input", "user_info", isset($_GET["user_info"]) ? $_GET["user_info"] : "", ["class" => "form-control", "placeholder" => "会员编号、昵称、手机号", "style" => "width:200px;display:inline;margin-left:5px;"]);
//echo '</li>';
echo '<li>';
echo Html::label("订单状态  ", "", ["style" => "margin-left:12px;"]);
...
echo Html::tag("span", "重置", ["class" => "search am-btn am-btn-primary", "style" => "margin-left:5px;", "onclick" => "location.href = '/subchannel/apiorder/index'"]);
