...
echo '<form action="/subchannel/withdraw/index" method="get">';
...
echo Html::tag("span", "提现申请", ["class" => "search am-btn am-btn-primary", "style" => "margin-left:5px;", "onclick" => "add()"]);
//echo Html::tag("span", "绑定银行卡", ["class" => "search am-btn am-btn-primary", "style" => "margin-left:5px;", "onclick" => "addBanks()"]);
echo Html::tag("span", "重置", ["class" => "search am-btn am-btn-primary", "style" => "margin-left:5px;", "onclick" => "location.href='/subchannel/withdraw/index'"]);
echo '</li>';
echo "</ul>";
echo '</form>';
...
<script type="text/javascript">
    //新增提现申请
    function add(){
        modDisplay({width: 500, height: 500, title: "提现申请", url: "/subchannel/withdraw/add-withdraw"});
    }
</script>