...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "POST",
            url: "/subchannel/betlist/lan-detail",
            ...
            success: function (json) {
                ...
                var dealOrder = json['result']['dealOrder'];
...
//                            competHtml += "<img class='orderImg' src='" + picAry[i] + "'>";
                ...
                betHtml += t4;
                var t5 = "<table class='table table-striped table-bordered modalTable'style='width:92%;' id='detailList'> 出票明细";
                t5 += "<tr><th  style='text-align: center;'>#</th><th  style='text-align: center;'>场次</th><th style='text-align: center;'>过关方式</th><th  style='text-align: center;'>倍数</th><th  style='text-align: center;'>投注金额</th><th  style='text-align: center;'>状态</th><th  style='text-align: center;'>中奖金额</th></tr>";
                $.each(dealOrder, function (key, val) {
                    t5 += "<tr style='text-align: center;'><td>" + eval(key + 1) + "</td>";
                    t5 += "<td style='width:140px;'>"
                        t5 += val.bet;
                    t5 += "</td><td>" + val.play_name + "</td><td>" + val.bet_double + "</td><td>" + val.bet_money + "</td><td>" + val.statusName + "</td>";
                    if (val.win_amount != "0.00") {
                        t5 += "<td style='color:red'>" + val.win_amount + "</td>"
                    } else {
                        t5 += "<td>--</td>"
                    }
                    t5 += "</tr>";
