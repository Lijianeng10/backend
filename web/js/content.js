...
function leftNavItemclick(_this, winHeight) {
...
//    var url = $(_this).data("url");
    ...
    var html = '<iframe src="' + url + '" class="pageiframe pageiframeactive"  data-url="' + url + '" style="height:' + winHeight + 'px;"></iframe>'
    $('#iframenavs .iframenav span').removeClass("activepage");
    $(".pageiframe").removeClass("pageiframeactive");
    $(".content").append(html);
...
function mytopnavClick(_this) {
    ...
    $(".tpl-left-nav-list .tpl-left-nav-menu[data-url='" + url + "']").find("a").each(function () {
        if ($(this).data("url") != undefined && $(this).data("url") != "") {
            leftNavItemclick(this, window._winHeight);
            return false;
        }
    });
}
...
function modDisplay2(options) {
    ...
    var html = '<div class="preview_page">' + data.content + '</div>';
    ...
    var html = '<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">\
                            <div class="am-modal-dialog">\
                              ...
                              <div class="am-modal-bd">\
                                ...
                                <input type="number" id="num" value=' + value + '>\
                              </div>\
                              <div class="am-modal-footer">\
                                <span class="am-modal-btn" data-am-modal-confirm>确定</span>\
                                <span class="am-modal-btn" data-am-modal-cancel>取消</span>\
...
function msgShowPrompt(title, msg,value,txt,log, onConfirmfunction, onCancelfunction) {
    var defaultfun = function () {};
    onConfirmfunction = onConfirmfunction || defaultfun;
    onCancelfunction = onCancelfunction || defaultfun;
    if ($("#my-confirm").length > 0) {
    ...
    var html = '<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">\
                            <div class="am-modal-dialog">\
                              ...
                              <div class="am-modal-bd">\
                                ...
                                <span id="txt">'+ txt +'</span><input type="number" id="num" value=' + value + '><span id="log" style="padding:5px">'+ log +'</span>\
                              </div>\
                              <div class="am-modal-footer">\
                                <span class="am-modal-btn" data-am-modal-confirm>确定</span>\
                                <span class="am-modal-btn" data-am-modal-cancel>取消</span>\
